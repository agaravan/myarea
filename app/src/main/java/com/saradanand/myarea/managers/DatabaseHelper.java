...
package com.saradanand.myarea.managers;
...
import com.saradanand.myarea.ApplicationHelper;
import com.saradanand.myarea.Constants;
...
import com.saradanand.myarea.managers.listeners.OnPostListChangedListener;
import com.saradanand.myarea.managers.listeners.OnProfileCreatedListener;
...
import com.saradanand.myarea.model.PostListResult;
import com.saradanand.myarea.model.Profile;
import com.saradanand.myarea.utils.LogUtil;
...
//        Sets the maximum time to retry upload operations if a failure occurs.
    ...
    public Task<Void> removeImage(String imageTitle) {
        StorageReference storageRef = storage.getReferenceFromUrl("gs://com.saradanand.com.saradanand.myarea.appspot.com");
